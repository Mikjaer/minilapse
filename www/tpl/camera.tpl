<img src="image.jpg" style="width: 90%; margin-left: 5%;">
...
<div class="ui-grid-b">
	...
	<div class="ui-block-c"> <a href="?p=camera&a=update" class="ui-shadow ui-btn ui-corner-all{if $status.running == "true"} ui-state-disabled{/if}" data-ajax="false">Update</a></div>
</div>
